...
*/
    ...
    private static void testSonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) { // her bir ogrenciye bakar
            ...
            int sayac=0;  // her bir ogrenci için doğru cevapları sayacağı için buraya konur
            for (int j = 0; j < answers[i].length; j++) { // her ogrencinin cevaplarina bakar, öğrenci cevaplari
